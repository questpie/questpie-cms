...
<Cards>
  <Card href="/docs/admin/preview/click-to-focus" title="Click-to-Focus" description="Click preview to focus fields" />
  <Card href="/docs/admin/blocks" title="Block System" description="Create blocks for page builder" />
</Cards>
