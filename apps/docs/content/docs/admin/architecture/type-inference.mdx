...
```typescript
import type { CollectionNames } from "@questpie/admin/builder";
...
```typescript
import type { GlobalNames } from "@questpie/admin/builder";
...
<Cards>
  <Card href="/docs/admin/qa-from" title="Scoped Helpers" description="Type-safe field access" />
