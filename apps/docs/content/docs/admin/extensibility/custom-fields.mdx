...
<Cards>
  <Card href="/docs/admin/extensibility/custom-views" title="Custom Views" description="Create custom view types" />
  <Card href="/docs/admin/architecture/registry-pattern" title="Registry Pattern" description="How fields are registered" />
</Cards>
