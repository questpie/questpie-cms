...
<Cards>
  <Card href="/docs/admin/fields" title="Field Types" description="All 22+ field types" />
  ...
  <Card href="/docs/admin/preview" title="Live Preview" description="Real-time content preview" />
</Cards>
