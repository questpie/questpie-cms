...
<Cards>
  <Card href="/docs/admin/fields" title="Field Types" description="All 22+ field types and their options" />
  <Card href="/docs/admin/architecture/proxy-pattern" title="Proxy Pattern Deep Dive" description="How the proxy pattern works internally" />
</Cards>
