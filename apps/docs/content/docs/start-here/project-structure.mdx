...
import type { AppCollections, AppGlobals, AppFunctions, AppRoutes, AppJobs } from "./module";
...
export type { AppConfig, AppCollections, AppGlobals, AppFunctions, AppRoutes, AppJobs };
```
