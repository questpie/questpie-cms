...
Changes to apply:
  ...
  • Added column "posts"."featured"
  • Added index "posts_featured_idx"
...
- [Collections](/docs/server/collections) - Define your schema
- [Field Builder](/docs/server/field-builder) - Field system overview
- [Field Types](/docs/server/field-types) - Built-in and custom field types
- [q Builder API](/docs/reference/q-builder-api) - Full builder config surface
