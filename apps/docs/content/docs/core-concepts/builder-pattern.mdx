...
QUESTPIE uses a **fluent builder API** to define collections. This approach allows for progressive type inference—as you chain methods to configure your collection, TypeScript automatically updates the inferred type of your data model.
...
```typescript
import { collection } from '@qcms/core'
...
```typescript
const baseContent = collection('base_content')
  .fields({
...
<Cards>
  <Card
    ...
    description="Understand how QUESTPIE derives types from your definitions."
