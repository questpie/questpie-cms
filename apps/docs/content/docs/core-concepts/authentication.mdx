...
<Cards>
  <Card href="/docs/guides/authentication" title="Auth Guide" description="Complete setup guide" />
  <Card href="/docs/backend/access-control" title="Access Control" description="Permission rules" />
  <Card href="/docs/backend/context" title="Context" description="Request context" />
</Cards>
