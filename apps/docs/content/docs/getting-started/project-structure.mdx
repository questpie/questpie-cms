...
- [Backend](/docs/backend) - Learn the q() builder
- [Admin UI](/docs/admin) - Configure the admin interface
- [Example](/docs/examples/barbershop) - See a real project structure
