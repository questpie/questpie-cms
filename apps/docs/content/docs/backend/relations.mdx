...
<Callout type="info">
  Many-to-many relations work with both Collections and Globals. Use the same
  API in globals for managing relations.
</Callout>
...
- [Collections](/docs/core-concepts/collections) - Define your data models
- [Hooks](/docs/backend/hooks) - Handle relation side effects
- [Getting Started](/docs/getting-started) - Step-by-step examples
