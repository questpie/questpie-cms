...
<Cards>
  <Card href="/docs/backend/crud-operations" title="CRUD Operations" description="Query with locales" />
  <Card href="/docs/backend/versioning" title="Versioning" description="Version history" />
  <Card href="/docs/admin" title="Admin UI" description="Locale switching in admin" />
</Cards>
