...
See [Relations](/docs/backend/relations) for detailed documentation.
...
See [Hooks](/docs/backend/hooks) for complete documentation.
...
Field-level access is configured directly in field definitions:
...
See [Access Control](/docs/backend/access-control) for complete documentation.
...
- [Hooks](/docs/backend/hooks) - Lifecycle events
- [Access Control](/docs/backend/access-control) - Security
- [Fields](/docs/core-concepts/fields) - Field types and validation
