...
<Cards>
  <Card href="/docs/backend/adapters/realtime" title="Realtime" description="Live updates" />
  <Card href="/docs/backend/search" title="Search Guide" description="Complete search guide" />
</Cards>
