...
<Cards>
  <Card href="/docs/backend/adapters" title="Adapters Overview" description="All backend adapters" />
  <Card href="/docs/guides/deployment" title="Deployment" description="Production deployment" />
</Cards>
