...
<Cards>
  <Card href="/docs/backend/collections" title="Collections" description="Define your data models" />
  <Card href="/docs/backend/builder-api" title="Builder API" description="Complete q() reference" />
  <Card href="/docs/guides/authentication" title="Authentication" description="Set up user auth" />
  <Card href="/docs/adapters" title="Adapters" description="Connect to your framework" />
</Cards>
