export declare const reviews: import("questpie").CollectionBuilder<import("questpie").SetProperty<import("questpie").TypeMerge<import("questpie").UnsetProperty<import("node_modules/questpie/src/server/collection/builder/types").EmptyCollectionState<"reviews", import("questpie").QuestpieBuilder<{
    ...
    fields: {
        ...
        readonly customerName: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly customerEmail: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly barber: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly appointment: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly rating: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly comment: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly isApproved: import("drizzle-orm/pg-core").AnyPgColumn;
        readonly isFeatured: import("drizzle-orm/pg-core").AnyPgColumn;
    };
    localized: readonly string[];
    fieldDefinitions: {
        ...
        readonly customerName: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"text", {
            readonly label: {
                readonly en: "Customer Name";
                readonly sk: "Meno zákazníka";
            };
            readonly required: true;
            readonly maxLength: 255;
        }, string, import("drizzle-orm/pg-core").AnyPgColumn, {
        ...
        readonly customerEmail: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"email", {
            readonly label: {
                readonly en: "Customer Email";
                readonly sk: "Email zákazníka";
            };
            readonly maxLength: 255;
        }, string, import("drizzle-orm/pg-core").AnyPgColumn, {
            column: {
        ...
        readonly appointment: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"relation", {
            readonly to: "appointments";
            readonly label: {
                readonly en: "Appointment";
                readonly sk: "Rezervácia";
            };
        }, string | string[] | {
            type: string;
            id: string;
        ...
        readonly rating: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"select", {
            readonly required: true;
            readonly label: {
                readonly en: "Rating";
                readonly sk: "Hodnotenie";
            };
            readonly options: readonly [{
                readonly value: "1";
                readonly label: {
                    readonly en: "1 Star";
                    readonly sk: "1 Hviezdička";
                };
            }, {
                readonly value: "2";
                readonly label: {
                    readonly en: "2 Stars";
                    readonly sk: "2 Hviezdičky";
                };
            }, {
                readonly value: "3";
                readonly label: {
                    readonly en: "3 Stars";
                    readonly sk: "3 Hviezdičky";
                };
            }, {
                readonly value: "4";
                readonly label: {
                    readonly en: "4 Stars";
                    readonly sk: "4 Hviezdičky";
                };
            }, {
                readonly value: "5";
                readonly label: {
                    readonly en: "5 Stars";
                    readonly sk: "5 Hviezdičiek";
                };
            }];
        }, string | string[], import("drizzle-orm/pg-core").AnyPgColumn, {
            column: {
        ...
        readonly comment: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"textarea", {
            readonly label: {
                readonly en: "Comment";
                readonly sk: "Komentár";
            };
        ...
        readonly isApproved: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"boolean", {
            readonly label: {
                readonly en: "Approved";
                readonly sk: "Schválené";
            };
            readonly default: false;
            readonly required: true;
        }, boolean, import("drizzle-orm/pg-core").AnyPgColumn, {
        ...
        readonly isFeatured: import("questpie").FieldDefinition<import("questpie").BuildFieldState<"boolean", {
            readonly label: {
                readonly en: "Featured";
                readonly sk: "Odporúčané";
            };
            readonly default: false;
            readonly required: true;
        }, boolean, import("drizzle-orm/pg-core").AnyPgColumn, {
