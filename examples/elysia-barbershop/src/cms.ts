 ...
 */
export const services = q.collection("services").fields({
  name: varchar("name", { length: 255 }).notNull(),
...
const appointmentConfirmationTemplate = q.email({
...
const appointmentCancellationTemplate = q.email({
...
const sendAppointmentConfirmation = q.job({
...
const sendAppointmentCancellation = q.job({
...
const sendAppointmentReminder = q.job({
