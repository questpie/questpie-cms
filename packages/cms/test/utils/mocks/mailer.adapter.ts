import type { MailAdapter } from "#questpie/cms/server/integrated/mailer/adapter.js";
import type { SerializableMailOptions } from "#questpie/cms/server/integrated/mailer/types.js";
