 ...
 * - `"edit"` → used in `.form()` callback via `v.myView()`
 *
 ...
 * export default view<WizardConfig>("wizard", { kind: "edit" });
 * ```
 */
 ...
 * @deprecated Use `view(name, { kind: "edit", ... })` instead.
 */
...
// ============================================================================
// View Filtering (for codegen-generated listViews/editViews)
// ============================================================================

/**
 * Filter a views record by kind, returning only views matching the specified kind.
 *
 * Used by codegen to derive `listViews`/`editViews` from the unified `views` category.
 * Each view file defines `view("name", { kind: "list"|"edit" })`. This function
 ...
 * editViews: filterViewsByKind({ table: _view_table, form: _view_form }, "edit"),
 * ```
 */
