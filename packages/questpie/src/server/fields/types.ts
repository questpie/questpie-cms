 ...
 * Codegen augments this interface from module-contributed field maps,
 * so user code gets autocomplete for valid field type names.
 *
 * When no modules are loaded (empty registry), `FieldType` falls back to `string`.
 *
 * @example
 * ```ts
