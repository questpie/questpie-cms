...
export class DrizzleMigrationGenerator {
	...
	private updateMigrationsIndex(
		...
		const indexContent = `import type { Migration } from "@questpie/core/server/migration/types";
${imports.join("\n")}
...
`;
	...
	private generateMigrationTemplate(options: {
		...
		return `import type { Migration } from "@questpie/core/server/migration/types"
